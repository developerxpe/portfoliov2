...
function Contact() {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:text-row max-w-7xl justify-evenly mx-auto items-center">
     <a href="contact"> <h3 id="contact" className="tracking-[20px] text-center uppercase text-gray-500 text-2xl">
        Contact
      </h3></a>
      ...
      <div className="flex flex-col space-y-5 items-start justify-center">
        <div className="space-y-5">
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-xl text-white text-center">Ankara | TURKEY</p>
          </div>
        </div>
